...
On average, across all days in the dataset the `r maxinterval`-minute interval contains the maximum number of steps.
...
The mean total number of steps taken per day with imputed values included is `r imputed_mn`. The mean value calculated with imputed values is the same as the mean value calculated when ignoring NA values.

The median total number of steps taken per day with imputed values included is `r imputed_md`. The median value caclulated with imputed values increased very slightly in comparison to the median value calculated when ignorning NA values.
